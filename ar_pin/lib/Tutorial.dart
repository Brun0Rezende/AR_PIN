                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(119 * fem, 113 * fem, 106 * fem, 112 * fem),
                                  width: double.infinity,
                                  decoration: BoxDecoration(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  margin: EdgeInsets.fromLTRB(0 * fem, 0 * fem, 2 * fem, 135 * fem),
                                  width: 919 * fem,
                                  height: 124.63 * fem,
                                  decoration: BoxDecoration(
                                ...
                                Container(
                                  ...
                                  margin: EdgeInsets.fromLTRB(2 * fem, 0 * fem, 0 * fem, 43.37 * fem),
                                  width: 919 * fem,
                                  height: 124.63 * fem,
                                  decoration: BoxDecoration(
                                    color: Color(0xffe51f43),
